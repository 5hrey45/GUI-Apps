...
def create_window(theme):
    ...
    layout = [
        [sg.Text('', font='Franklin 26',
                 expand_x=True, justification='right', pad=(10, 20), right_click_menu=theme_menu, key='-TEXT-')],
        ...
        [sg.Button('0', size=button_size, expand_x=True), sg.Button(
...
theme_menu = ['menu', ['LightGray1', 'DarkGrey8', 'dark', 'random']]

window = create_window('Material1')
